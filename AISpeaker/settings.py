"""
Django settings for AISpeaker project.
...
SECRET_KEY = '!1^5dd%&gpziwju=-!&-9@zsx8v(z#%p92anc7y6%!*+=tg39_'
...
WSGI_APPLICATION = 'AISpeaker.wsgi.application'
...
DATABASE_ROUTERS = [
    'speakerapp.routers.MultiDBRouter',
]
